...
class Node():
    ...
    def verify_msg_digest(self, pbft_request, digest, client_id):
    ...
    def send_pubkey(self, remote_host, host):
    ...
    def recv_pubkey(self, info):
        ...
        if client_id in self.client_ids:
            ...
            return res
        res = {'code': 0, 'id': self.identity.id, 'pubkey_x': self.identity.pub_point.x,
               'pubkey_y': self.identity.pub_point.y}
        return res
    ...
    def resolve_info(self, entity, info):
        for key in info:
